...
func _ready() -> void:
	...
	oikake.enter_house_wait_exit.set_instance(OikakePattern)
	
	machibuse.start_game.set_instance(MachibusePattern)
	machibuse.enter_house_wait_exit.set_instance(MachibusePattern)
	
	kimagure.start_game.set_instance(KimagurePattern)
	kimagure.enter_house_wait_exit.set_instance(KimagurePattern)
	
	otoboke.start_game.set_instance(OtobokePattern)
	otoboke.enter_house_wait_exit.set_instance(OtobokePattern)
